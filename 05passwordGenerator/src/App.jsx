...
function App() {
  ...
  //useRef for copy password to clipboard
...
//isme copy krenge to clipboard me kitna copy krna h usme dikat aayegi
//to iske liye useRef ka use krenge
  useEffect(() => {
    passwordGenerator()
